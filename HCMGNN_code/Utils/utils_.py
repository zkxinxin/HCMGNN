...
def parameters_set():
    ...
    parser.add_argument('--loss_gamma', type=float, default=0.7, help="balance coefficient")
    parser.add_argument('--hidden_size', type=int, default=64, help='model hidden dim')
    parser.add_argument('--num_heads', type=int, default=8, help='number of heads of GAT')
    ...
    parser.add_argument('--metapaths', nargs='+',
                        default=[['g', 'm', 'd'], ['m', 'g', 'd'], ['d', 'g', 'm'], ['d', 'm', 'g'], ['g', 'd', 'm'],
                                 ['m', 'd', 'g']],
